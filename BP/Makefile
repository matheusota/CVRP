...
MYLIBSOURCES = mygraphlib.cpp geompack.cpp myutils.cpp cvrpalgs.cpp cvrpcutscallback.cpp conspool.cpp cvrpalgsscip.cpp cvrpcutscallbackscip.cpp  cvrpbranchingrule.cpp dpcaller.cpp cvrppricerscip.cpp cvrpbranchingmanager.cpp
